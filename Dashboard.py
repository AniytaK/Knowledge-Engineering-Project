...
fhgr = pd.read_csv("D:/Studium/3_HS 2023/KE and E/Projekt/masterstudiengang_details_fhgr.csv")
fhnw = pd.read_csv("D:/Studium/3_HS 2023/KE and E/Projekt/masterstudiengang_details_fhnw.csv")
#_______________________________________________________________________________________________________________________
        ...
        children=[
            dbc.Container([
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        dbc.Row([html.H1("Schulauswahl:", style={'margin-left': '-150px', 'font-family': 'Source Sans Pro',
                                                                 'font-size': '32px', 'font-weight': 'bold', "color": "#e5e5e5"}),
                            dcc.Checklist(
                                id='school-checklist',
                                options=[
                                ...
                                style={'margin-left': '-150px', 'font-family': 'Source Sans Pro', 'font-size': '22px',
                ...
                dbc.Row([
                        dbc.Col(html.H1("MASTERSTUDIENANGEBOT:"),
                            width=8,
                            className='text-center d-flex align-items-right',
                            style={'background-color': '#fcbf49', 'font-size': '32px', 'font-weight': 'bold', 'border-radius': '5px',
                                   ...
                                   'font-family': 'Source Sans Pro', 'font-size': '22px', 'font-weight': 'bold',}),
...
def update_output(selected_schools):
    return 'Sie haben folgende Schule ausgewählt: ' + ', '.join(selected_schools)
